...
class Language {
  ...
  static String skipForNow = myMap['Skip_for_Now'];
  static String didNotReceived = myMap['I_dont_received_a_code'];
  static String resend = myMap['Resend'];
  static String days = myMap['Days'];
  static String minutes = myMap['Minutes'];
  static String seconds = myMap['Seconds'];
  ...
  static String enterValidEmail = myMap['Enter_valid_emai'];
  ...
  static String editAddress = myMap['Edit_Address'];
