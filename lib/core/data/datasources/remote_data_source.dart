...
class RemoteDataSourceImpl implements RemoteDataSource {
  ...
  final demoModeHeader = {
    'Accept': 'application/json',
    'X-Requested-With': 'XMLHttpRequest'
  };
  final demoModeHeader2 = {
  ...
  Future<String> updateProfileInformation(
    ...
    final clientMethod =
        client.post(uri, headers: demoModeHeader, body: dataMap);
    final responseJsonBody =
        await NetworkParser.callClientWithCatchException(() => clientMethod);
  ...
  Future<SearchResponseModel> searchProduct(Uri uri) async {
    final clientMethod = client.get(uri, headers: demoModeHeader2);
    final responseJsonBody =
        await NetworkParser.callClientWithCatchException(() => clientMethod);
  ...
  Future<String> activeAccountCodeSubmit(String code) async {
    ...
    final clientMethod = client.get(uri, headers: demoModeHeader);
  ...
  Future<ContactUsModel> getContactUsContent() async {
    ...
    if (responseJsonBody['contact'] != null) {
      return ContactUsModel.fromMap(responseJsonBody['contact']);
    } else {
      return ContactUsModel.fromMap(responseJsonBody);
    }
  }
  ...
  Future<PrivacyPolicyAndTermConditionModel> getPrivacyPolicy() async {
    ...
    if (responseJsonBody['privacyPolicy'] != null) {
      return PrivacyPolicyAndTermConditionModel.fromMap(
          responseJsonBody['privacyPolicy']);
    } else {
      return PrivacyPolicyAndTermConditionModel.fromMap(responseJsonBody);
    }
  }
  ...
  @override
  Future<ProductCategoriesModel> getCategoryProducts(String slug) async {
    final uri = Uri.parse(RemoteUrls.categoryProducts(slug));
  ...
  @override
  Future<List<CategoriesModel>> getCategoryLists() async {
    ...
    return List<CategoriesModel>.from(
        mapList.map((e) => CategoriesModel.fromMap(e)));
  }
